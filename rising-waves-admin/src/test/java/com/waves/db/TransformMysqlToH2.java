 ...
 * 2.'`'全部要去掉
 *
 * 3.字段的字符集设置'COLLATE utf8_bin'不支持, 需要删除, 如这样的'`operator` varchar(10) COLLATE utf8_bin NOT
 * NULL'
 *
 ...
 *
 * 6.'DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP'不支持, 修改为H2类似的'AS
 * CURRENT_TIMESTAMP'
 *
...
public class TransformMysqlToH2 {
	...
	public static void main(String[] args) throws Exception {
		File file = new File(
				"/Users/apple/mycode/workspaces/yookoo/rising-waves/rising-waves-cms/src/main/resources/sql/h2/h2.sql");
